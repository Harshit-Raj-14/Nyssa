...
export default function CalendarScreen() {
  ...
  const redDates = ["3/6/2025", "3/7/2025", "3/8/2025"];
  const blueDates = ["4/7/2025", "4/8/2025", "5/8/2025", "5/9/2025"];
  ...
  const renderCalendar = () => {
    ...
    for (let day = 1; day <= days; day++) {
      ...
      const isRed = redDates.includes(dateString);
      const isBlue = blueDates.includes(dateString);
      ...
      week.push(
        <TouchableOpacity
          ...
          style={[
            ...
            isRed && styles.redDate,
            isBlue && styles.blueDate,
          ]}
        ...
        <View key={medication.id} style={styles.medicationCard}>
          ...
          {taken ? (
            <View style={styles.takenBadge}>
              ...
              <Text style={styles.takenText}>Alerted</Text>
            </View>
          ) : (
            <TouchableOpacity
              style={[
            ...
            >
              <Text style={styles.takeDoseText}>Alert</Text>
            </TouchableOpacity>
          )}
        </View>
      );
...
const styles = StyleSheet.create({
  ...
  redDate: {
    ...
    width: 40,        // Ensures equal width and height
    height: 40,
    justifyContent: "center",
    alignItems: "center",
  },
  ...
  calendarDay: {
    ...
    justifyContent: "center",
    alignItems: "center",
    margin: 5, // Adds spacing between dates
  },
  dayText: {

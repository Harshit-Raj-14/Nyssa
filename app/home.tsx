...
const QUICK_ACTIONS = [
  ...
  {
    icon: "notifications-circle" as const,
    label: "Cup\nAlerts",
        ...
        <View style={styles.headerContent}>
          <View style={styles.headerTop}>
            <View style={styles.flex1}>
              <Text style={styles.greeting}>AI Period Tracker</Text>
            </View>
            <TouchableOpacity

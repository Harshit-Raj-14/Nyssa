...
const DURATIONS = [
  { id: "1", label: "Smile", icon: "smile", value: 1 },
  { id: "2", label: "Moderate", icon: "face-frown-open", value: 15 },
  { id: "3", label: "Painful", icon: "sad-cry", value: 30 },
  { id: "4", label: "Fatigued", icon: "face-dizzy", value: 90 },
  { id: "5", label: "Cramping", icon: "face-tired", value: -1 },
];
    ...
    return (
      <View style={styles.optionsGrid}>
        {DURATIONS.map((dur) => (
          ...
          >
            <FontAwesome6 name={dur.icon} size={40} color={selectedDuration === dur.label ? "white" : "black"} />
            <Text
              style={[
                styles.optionLabel,
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Enter Period Data</Text>
        </View>
        ...
        >
          ...
          <Text>{"\n"}</Text>
          <Text style={styles.sectionTitle}>Enter date</Text>
          <TouchableOpacity
          ...
          <View style={styles.section}>
            ...
            {form.frequency && form.frequency !== "As needed" && (
              <View style={styles.timesContainer}>
                <Text style={styles.timesTitle}>Time</Text>
            ...
            <View style={styles.card}>
              <View style={styles.switchRow}>
                <View style={styles.switchLabelContainer}>
                  ...
                  <View>
                    <Text style={styles.switchLabel}>Reminders{"\n"}</Text>
                    <Text style={styles.switchSubLabel}>
                      Get notified when the menstrual cup is full
                    </Text>
                  </View>
                </View>
                <Switch
          ...
          <View style={styles.section}>
            <View style={styles.textAreaContainer}>
              <TextInput
                ...
                placeholder="Add notes or any abnormality you observed..."
                placeholderTextColor="#999"
                value={form.notes}
